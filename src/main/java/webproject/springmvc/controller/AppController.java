...
import webproject.springmvc.model.FileBucket;
import webproject.springmvc.service.UserProfileService;
import webproject.springmvc.service.UserService;
import webproject.springmvc.service.UserDocumentService;
import webproject.springmvc.util.FileValidator;
...
public class AppController {
	...
	public String listUsers(ModelMap model) {
		...
		model.addAttribute("loggedinuser", getSSO());
		User user=userService.findBySSO(getSSO());
